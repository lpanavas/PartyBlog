...
function MyDB() {    
    ...
    database.addComment = async(comments) => {
        ...
        const update = {$push: {commentList: {firstName: comments[1], lastName: comments[2], comment: comments[3]}}
          };
        // userCollection.findOneAndUpdate(
        //     {_id: comments[0]},
        //     {$push: {comments: {firstName: comments[1], lastName: comments[2], comment: comments[3]}}}
        // );
